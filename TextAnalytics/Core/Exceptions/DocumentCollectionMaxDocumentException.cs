...
namespace TextAnalytics.Core.Exceptions
{
    ...
    public class DocumentCollectionMaxDocumentException : Exception
    {
        ...
        /// </summary>
        public override string Message => $"Document collection has {DocumentCount} documents. The maximum number of documents for a collection is {MaximumDocumentCount}.";
